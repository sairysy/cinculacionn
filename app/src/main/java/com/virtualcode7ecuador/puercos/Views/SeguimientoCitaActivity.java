...
import static com.virtualcode7ecuador.puercos.FragmentsAgendador.AgendarCitaFragment.REQUEST_CODE_TAKE_PHOTO;
            ...
            case R.id.id_imageview_seguimiento_cita___:
                if (allPermissionGranted()) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        ...
                        Toast.makeText(this, "NO ADMITE...", Toast.LENGTH_SHORT).show();
                    }
                } else {
